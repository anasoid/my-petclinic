...
export const Pet = () => {
  ...
  const totalItems = useAppSelector(state => state.pet.totalItems);
            ...
            <tbody>
              {petList.map((pet, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{pet.type ? <Link to={`/pet-type/${pet.type.id}`}>{pet.type.name}</Link> : ''}</td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/pet/${pet.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
