...
export const SpecialtyDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/specialty' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="petclinicApp.specialty.delete.question">Are you sure you want to delete Specialty {specialtyEntity.id}?</ModalBody>
      <ModalFooter>
