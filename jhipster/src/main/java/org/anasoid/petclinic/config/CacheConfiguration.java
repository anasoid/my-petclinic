package org.anasoid.petclinic.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.anasoid.petclinic.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.anasoid.petclinic.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, org.anasoid.petclinic.domain.User.class.getName());
            ...
            createCache(cm, org.anasoid.petclinic.domain.Role.class.getName());
