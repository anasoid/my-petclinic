...
/**
 * Criteria class for the {@link org.anasoid.petclinic.domain.Pet} entity. This class is used
 * in {@link org.anasoid.petclinic.web.rest.PetResource} to receive all the possible filtering options from
...
public class PetCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, birthDate, typeId, visitsId, ownerId, distinct);
    }
