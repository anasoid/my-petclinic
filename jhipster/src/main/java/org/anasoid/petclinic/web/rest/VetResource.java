...
import org.anasoid.petclinic.service.VetQueryService;
...
/**
 * REST controller for managing {@link org.anasoid.petclinic.domain.Vet}.
 */
@RestController
...
public class VetResource {
    ...
    public ResponseEntity<Vet> createVet(@Valid @RequestBody Vet vet) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/vets/" + vet.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, vet.getId().toString()))
            .body(vet);
    }
